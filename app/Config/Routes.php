...
$routes->get('/survey/detailsuper/(:num)/(:num)/(:num)', 'Survey::detail/$1/$2/$3');
...
$routes->get('/pertanyaan/detailsuper/(:num)/(:num)/(:num)', 'Pertanyaan::detail/$1/$2/$3');
...
$routes->delete('/pertanyaanopsi/delete/(:num)/(:num)/(:num)', 'PertanyaanOpsi::delete/$1/$2/$3');
...
$routes->post('/opd/updateprofil', 'OPD::updateProfil');
...
$routes->post('/users/updateprofil', 'Users::updateProfil');
...
$routes->get('/responden/surveyresponden/(:num)', 'Responden::surveyResponden/$1');
...
/* List Berita by Responden */
$routes->get('/responden/berita', 'Responden::berita');
/* List Detail Berita by Responden */
$routes->get('/responden/detailberita/(:num)', 'Responden::detailBerita/$1');
/* List List Berita Survey by Responden */
$routes->get('/responden/beritasurvey/(:num)', 'Responden::beritaSurvey/$1');
/* Finish Access Berita by Responden */

/*Start Eksport */
$routes->get('/export/listsurvey', 'Export::listSurvey');
$routes->get('/export/laporanPrint/(:num)/(:num)', 'Export::laporanPrint/$1/$2');
...
$routes->get('/export/grafikPrint/(:num)', 'Export::grafikPrint/$1');
/*End Eksport */
