                    ...
                    <form id="kt_modal_new_target_form" class="form" action="#">
                        ...
                        <nav>
                            <ul class="pagination justify-content-center">
                                <?php if ($getHalaman > 1) : ?>
                                    <li class="page-item">
                                        <a class="page-link" href="/grafik/listopd/<?= $previous; ?>" ;>Previous</a>
                                    </li>
                                <?php endif; ?>
                                <?php
                                ...
                                ?>
                                    <?php if ($x == $halaman) : ?>
                                        <li class="page-item active"><a class="page-link" href="<?= site_url('/grafik/listopd/' . $x); ?>"><?php echo $x; ?></a>
                                        </li>
                                    <?php else : ?>
                                        <li class="page-item"><a class="page-link" href="<?= site_url('/grafik/listopd/' . $x); ?>"><?php echo $x; ?></a>
                                        </li>
                                    <?php endif; ?>
                                <?php
                                }
                                ?>
                                <?php if ($getHalaman < $total_halaman) : ?>
                                    <li class="page-item">
                                        <a class="page-link" href='/grafik/listopd/<?= $next; ?>'>Next</a>
                                    </li>
                                <?php endif; ?>
                            </ul>
                        </nav>
