                    ...
                    <div class="card mb-5 mb-xl-10 mt-10">
                        <div class="card mb-0" id="kt_profile_details_view">
                            <div class="modal-header pb-0 border-0 justify-content">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-center">
                                        <a href="<?= site_url('/laporan/index'); ?>" class="btn btn-outline-dark mt-auto" value="Go back!">
                            ...
                            <div class="mb-3 text-center">
                                <!--begin::Title-->
                                <h1 class="mb-3">Daftar Laporan Tahun <?= $tahun; ?></h1>
                                <!--end::Title-->
                            </div>
                            <!--begin::Card body-->
                            <div class="card-header border-0 mt-3">
                                <!--begin::Search-->
                                <div id="kt_header_search" class="d-flex align-items-center w-50" data-kt-search-keypress="true" data-kt-search-min-length="2" data-kt-search-enter="enter" data-kt-search-layout="menu" data-kt-search-responsive="false" data-kt-menu-trigger="auto" data-kt-menu-permanent="true" data-kt-menu-placement="bottom-start">
                                    ...
                                    <form data-kt-search-element="form" class="w-100 position-relative mb-5 mb-lg-0" autocomplete="off">
                                        ...
                                        <!--end::Icon-->
                                        <!--begin::Input-->
                                        <input type="text" class="search-input form-control form-control-solid ps-13" name="search" value="" placeholder="Cari" data-kt-search-element="input" />
                                        <!--end::Input-->
                                        <!--begin::Spinner-->
                                    ...
                                    <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="table1">
                                        ...
                                        <thead>
                                            <tr class="fw-bolder text-muted">
                                                ...
                                                <th class="w-10px text-center">Aksi</th>
                                            </tr>
                                        </thead>
                                        <!--end::Table head-->
                                        <!--begin::Table body-->
                                        <tbody>
                                            ...
                                            <?php foreach ($survey as $sv) : ?>
                                                <tr>
                                                    ...
                                                    <td class="text-center" data-kt-menu="true">
                                                        <a href="<?= site_url('/laporan/detail/' . $sv['survey_id']); ?>" class="btn btn-flex btn-primary btn-sm">Detail
                                                        </a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
