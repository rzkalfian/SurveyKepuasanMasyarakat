                    ...
                    <div class="card mb-5 mb-xl-10 mt-10">
                        <div class="card mb-0" id="kt_profile_details_view">
                            <div class="modal-header pb-0 border-0 justify-content">
                                <div class="d-flex">
                                    <div class="flex-shrink-0 text-center">
                                        <a href="<?= site_url('/laporan/listopd/' . $surveytahun); ?>"
                            ...
                            <div class="mb-3 text-center">
                                <!--begin::Title-->
                                <h1 class="mb-3">Daftar Laporan Tahun <?= $surveytahun; ?></h1>
                                <!--end::Title-->
                            </div>
                            <!--begin::Card body-->
                            <div class="card-header border-0 mt-3">
                                <!--begin::Search-->
                                <div id="kt_header_search" class="d-flex align-items-center w-50"
                                        ...
                                        <tbody id="myTable">
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-top text-center">
                                                    <span
                                                        class="badge badge-light-danger"><?= $sv['survey_status']; ?></span>
                                                </td>
                                                <td class="align-top text-center" data-kt-menu="true">
                                                    <a href="<?= site_url('/laporan/detaillaporanopd/' . $sv['survey_id']); ?>"
                                                        class="btn btn-flex btn-primary btn-sm">Detail
                                                    </a>
                                                </td>
                                            </tr>
                                            <?php endforeach; ?>
