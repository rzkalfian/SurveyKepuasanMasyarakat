        ...
        <div class="container-xxl" id="kt_content_container">
            <div class="row g-5 g-xl-6">
                <div class="card-toolbar d-flex justify-content-end mb-3">
                    <a type="button" href="<?= site_url('/export/grafikPrint/' . $survey['survey_id']) ?>" class="btn btn-sm btn-success my-1 mx-1">
                ...
                <?php foreach ($dataGrafiks as $grafik) : ?>
                    ...
                    <div class="card card-xl-stretch mb-xl-8 kartu">
                        ...
                        <div class="card-body d-flex justify-content-center">
                            <!--begin::Chart-->
                            <canvas id="myChart<?= $grafik['pertanyaan']['pertanyaan_id'] ?>" id="polar" style="position: relative; height:60vh; width:80vw"></canvas>
