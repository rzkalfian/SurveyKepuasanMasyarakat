                                ...
                                <div class="mb-16">
                                    ...
                                    <div class="row g-10">
                                        <?php foreach ($berita as $b) : ?>
                                            ...
                                            <div class="col-md-4">
                                                ...
                                                <div class="card-xl-stretch me-md-6">
                                                    ...
                                                    <div class="m-0">
                                                        <!--begin::Title-->
                                                        <a href="<?= site_url('/responden/detailberita/ ' . $b['berita_id']); ?>" class="fs-4 text-dark fw-bolder text-hover-primary text-dark lh-base">Judul
                                                            <?= $b['berita_judul']; ?>
                                                        </a>
                                                        <!--end::Title-->
                                                        <!--begin::Text-->
                                        ...
                                        <div class="text-center mt-19">
                                            <a href="<?= site_url('/responden/beritasurvey/' . $opd['opd_kode']); ?>" class="btn btn-flex btn-primary">Lihat
                                                Berita
                                                Lain
                                            </a>
                                        </div>
