    ...
    <!-- <script>
        $(document).ready(function() {
            $("button[type='submit']").click(function() {
                var selectedJawaban = $("input[name='opsi1']:checked").val();
                if (selectedJawaban) {
                    document.getElementById("result").innerHTML = "The Selected Values is : <b>" + selectedJawaban + "</b>";
                    document.getElementById("result").style.color = "blue";
                } else {
                    document.getElementById("result").innerHTML = "OPS ! Select The Option ...";
