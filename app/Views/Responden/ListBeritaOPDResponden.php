                                ...
                                <div class="card-body p-lg-17">
                                                ...
                                                <div data-tns="true" data-tns-loop="true" data-tns-swipe-angle="false"
                                                    ...
                                                    <div class="text-center px-5 pt-5 pt-lg-10 px-lg-10">
                                                        ...
                                                        <div class="fs-4 mb-6">
                                                            ...
                                                            <span
                                                                class="text-muted"><?= tanggal($b['tanggal']); ?></span>
                                                            <!--end::Date-->
                                                        </div>
                                                        <!--end::Content-->
                                                        <a class="d-block overlay mb-4"
                                                            data-fslightbox="lightbox-hot-sales"
                                                            href="<?= base_url(); ?>/img/beritaimage/<?= $b['berita_gambar']; ?>">
                                                            <div class="overlay-wrapper min-h-300px bgi-no-repeat bgi-position-center bgi-size-cover card-rounded"
                                                                style="background-image:url('<?= base_url(); ?>/img/beritaimage/<?= $b['berita_gambar']; ?>')">
                                                            </div>
                                                            <div
                                                                class=" overlay-layer bg-dark card-rounded bg-opacity-25">
                                                        ...
                                                        <div class="fs-5 fw-bold text-gray-600">
                                                            ...
                                                            <p class="m-0 justify">
                                                                ...
                                                                <a href="<?= site_url('responden/detailberita/' . $b['berita_id']); ?>"
                                                                    class="link-primary pe-1">Baca Selengkapnya</a>
                                                            </p>
                                                            <!--end::Text-->
                                                        </div>
                                                        <!--end::Description-->
                                    ...
                                    <div class="card-header border-0 pt-5 position-relative mb-6">
                                        ...
                                        <div id="kt_header_search"
                                            class="d-flex align-items-center w-75 position-absolute top-0 start-50 translate-middle-x"
                                            ...
                                            <form data-kt-search-element="form"
                                                ...
                                                <input type="text"
                                                    ...
                                                    data-kt-search-element="input" id="myFilter"
                                                    onkeyup="myFunction()" />
                                                <!--end::Input-->
                                                <!--begin::Spinner-->
                                                <span
                                            ...
                                            <div class="col col-md-4 col-6 kartu">
                                                ...
                                                <div class="card-xl-stretch me-md-6">
                                                    ...
                                                    <div class="m-0">
                                                        <!--begin::Title-->
                                                        <a
                                                            class="fs-4 text-dark fw-bolder text-dark lh-base card-title">
                                                            <?= $b['berita_judul']; ?>
                                                        </a>
                                                        <!--end::Title-->
                                                        <!--begin::Text-->
