                ...
                <div class="modal-header pb-0 border-0 justify-content">
                    ...
                    <div class="d-flex">
                        <div class="flex-shrink-0 text-center">
                            <a href="<?= site_url('/laporan/listopd/'); ?>" class="btn btn-outline-dark mt-auto"
                        ...
                        <div class="row g-6 g-xl-9 mb-6 mb-xl-9">
                            ...
                            <div class="col-md-6 col-lg-4 col-xl-3 col-6">
                                ...
                                <div class="card-body d-flex justify-content-center text-center flex-column p-8">
                                    <!--begin::Name-->
                                    <a href="<?= site_url('/laporan/listsurvey/' . $opd_kode . '/' . $sv['survey_tahun']); ?>"
                                        class="text-gray-800 text-hover-primary d-flex flex-column">
                                        <!--begin::Image-->
                                        <div class="symbol symbol-75px mb-5">
                                            <img src="<?= base_url(); ?>/assets/media/svg/files/folder-document.svg"
                                                alt="" />
                                        </div>
                                        <!--end::Image-->
                                        <!--begin::Title-->
                                        <div class="fs-5 fw-bolder mb-2"><?= $sv['survey_tahun']; ?></div>
                                        <!--end::Title-->
                                    </a>
                                    <!--end::Name-->
                                </div>
