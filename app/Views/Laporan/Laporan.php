                        ...
                        <form id="kt_project_settings_form" class="form">
                            ...
                            <div class="card-body p-9">
                                ...
                                <div class="row mb-8">
                                    ...
                                    <!--begin::Col-->
                                    <div class="col-xl-9 fv-row">
                                        <textarea name="survey_deskripsi" disabled class="form-control form-control-solid h-100px"><?= $survey['survey_deskripsi']; ?></textarea>
                                    </div>
                                    <!--begin::Col-->
                                </div>
                                <!--end::Row-->
                        ...
                        <div class="card-body py-3">
                            <div class="card-header border-0">
                                <div class="card-toolbar mb-4 d-flex justify-content-end">
                                    <div class="my-1 me-4">
                                        <a type="button" href="<?= site_url('/export/laporanPrint/' . $survey['survey_id']) ?>" class="btn btn-sm btn-success my-1">
                                        ...
                                        <a target="blank" type="button" href="<?= site_url('/export/laporanPdf/' . $survey['survey_id'] . '/' . $opd_kode) ?>" class="btn btn-sm btn-danger my-1">
                                            <!--begin::Svg Icon | path: icons/duotune/arrows/arr075.svg-->
                                            <span class="svg-icon svg-icon-2">
                                    ...
                                    <tbody>
                                        ...
                                        <?php foreach ($totalRespon as $tr) : ?>
                                            <tr>
                                                ...
                                                <td class="align-middle pertanyaan" rowspan="<?= (count($tr['opsi']) + 1); ?>">
