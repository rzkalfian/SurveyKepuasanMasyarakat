                                        ...
                                        <tbody id="myTable">
                                            ...
                                            <?php foreach ($survey as $sv) : ?>
                                                <tr>
                                                    ...
                                                    <td class="align-top">
                                                        <a class="justify text-dark fw-bolder d-block mb-1 fs-6"><?= $sv['survey_judul']; ?></a>
                                                    </td>
                                                    <td class="align-top text-center">
                                                        <span class="badge badge-light-<?= $sv['survey_status'] == 'Aktif' ? 'success' : 'danger' ?>"><?= $sv['survey_status']; ?></span>
                                                    </td>
                                                    <td class="align-top text-center" data-kt-menu="true">
                                                        <a href="<?= site_url('/laporan/laporan/' . $sv['survey_id'] . '/' . $opd_kode); ?>" class="btn btn-flex btn-primary btn-sm">Lihat
                                                        </a>
                                                    </td>
                                                    <td class="align-top text-center" data-kt-menu="true">
                                                        <a href="<?= site_url('grafik/grafik/' . $sv['survey_id']); ?>" class="btn btn-flex btn-primary btn-sm">Lihat
                                                        </a>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
