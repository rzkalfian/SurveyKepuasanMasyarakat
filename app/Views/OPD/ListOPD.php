        ...
        <div class="container-xxl" id="kt_content_container">
            ...
            <div class="card mb-5 mb-xl-8">
                <div class="card-header border-0 pt-5">
                    <!--begin::Search-->
                    <div id="kt_header_search" class="d-flex align-items-center w-75" data-kt-search-keypress="true"
                        ...
                        <table class="table table-row-bordered table-row-gray-100 align-middle gs-0 gy-3" id="table1">
                            ...
                            <tbody id="myTable">
                                ...
                                <tr>
                                    ...
                                    <td class="align-top">
                                        <a
                                            class="text-dark text-center fw-bolder d-block mb-1 fs-6"><?= $o['opd_kode']; ?></a>
                                    </td>
                                    <td class="align-top">
                                    ...
                                    <td class="text-center d-flex justify-content-center in-line align-top"
                                        data-kt-menu="true">
                                        <a href="<?= site_url('/opd/detail/' . $o['opd_kode']); ?>"
                                        ...
                                        <a href="<?= site_url('/opd/edit/' . $o['opd_kode']); ?>"
                                            class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm me-1">
                                        ...
                                        <form action="<?= site_url('/OPD/delete/' . $o['opd_kode']); ?>"
