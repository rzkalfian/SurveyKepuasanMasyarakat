        ...
        <div class="modal-dialog modal-dialog-centered mw-1000px">
            <div class="modal-content rounded">
                <div class="modal-header pb-0 border-0 justify-content">
                    <div class="d-flex">
                        <div class="flex-shrink-0 text-center">
                            ...
                            <a href="<?= site_url('/survey/detailsuper/' . $survey_id . '/' . $opd['opd_kode']) ?>"
                ...
                <div class="modal-body scroll-y px-10 px-lg-15 pt-0 pb-15">
                    ...
                    <form id="kt_modal_new_target_form" class="form" action="#">
                        ...
                        <form id="kt_project_settings_form" class="form">
                            ...
                            <div class="card-body p-9">
                                ...
                                <!--end::Row-->
                                <!--begin::Row-->
                                <?php foreach ($pertanyaanopsi as $po) : ?>
                                <div class="row mb-8">
                                    <div class="col-xl-10 col-8 fv-row">
                                        <input type="text" class="form-control form-control-solid"
                                            value="<?= $po['opsi_nama']; ?>" disabled />
                                    </div>
                                    <?php if (session()->get('users_opd_kode') == $opd['opd_kode']) : ?>
                                    <a href="<?= site_url('/pertanyaanopsi/edit/' . $po['pertanyaanopsi_id'] . '/' . $po['pertanyaan_id'] . '/' . $survey_id); ?>"
                                    ...
                                    <a href="<?= site_url('/pertanyaanopsi/delete/' . $po['pertanyaanopsi_id'] . '/' . $po['pertanyaan_id'] . '/' . $survey_id); ?>"
                                        class="btn btn-icon btn-bg-light btn-active-color-primary btn-sm btn-hapus">
                    ...
                    <?php if (session()->get('users_opd_kode') == $opd['opd_kode']) : ?>
                    <form method="POST"
                        action="<?= site_url('/pertanyaanopsi/create/' . $pertanyaan_id . '/' . $survey_id); ?>"
                            ...
                            <div class="row g-9 mb-8">
                                ...
                                <div class="d-flex flex-column col-xl-10 col-8 fv-row">
                                    <select class="selectpicker col-12" data-live-search="true"
                                        ...
                                        <option value="<?= $op['opsi_id']; ?>"><?= $op['opsi_nama']; ?></option>
                                        <?php endforeach ?>
                                    </select>
                                ...
                                <div class="text-center">
                                    <a type="button"
                                        href="<?= site_url('/opsi/add/' . $pertanyaan_id . '/' . $survey_id); ?>"
