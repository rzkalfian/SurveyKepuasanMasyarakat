                                   ...
                                   <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 px-6 my-5 my-lg-0" id="kt_aside_menu" data-kt-menu="true">
                                       <div class="nav-item mb-2 text-center" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Dashboard">
                                           ...
                                           <a href="<?= site_url('/dashboard/'); ?>">
                                               <div class="nav-link menu-link btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light <?= current_url(true)->getSegment(2) == 'dashboard' ? 'active' : ''; ?>" data-bs-toggle="tab">
                                       ...
                                       <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 px-6 my-5 my-lg-0" id="kt_aside_menu" data-kt-menu="true">
                                           <div class="nav-item mb-2 text-center" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="OPD">
                                               ...
                                               <a href="<?= site_url('/opd/index'); ?>">
                                                   <div class="nav-link btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light <?= current_url(true)->getSegment(2) == 'opd' ? 'active' : ''; ?>" data-bs-toggle="tab">
                                       ...
                                       <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 px-6 my-5 my-lg-0" id="kt_aside_menu" data-kt-menu="true">
                                           <div class="nav-item mb-2 text-center" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Opsi">
                                               ...
                                               <a href="<?= site_url('/opsi'); ?>">
                                                   <div class=" nav-link btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light <?= current_url(true)->getSegment(2) == 'opsi' ? 'active' : ''; ?>" data-bs-toggle="tab">
                                                       <!--begin::Svg Icon | path: icons/duotune/general/gen032.svg-->
                                                       <span class="svg-icon svg-icon-2x">
                                       ...
                                       <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 px-6 my-5 my-lg-0" id="kt_aside_menu" data-kt-menu="true">
                                           <div class="nav-item mb-2 text-center" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Survey">
                                               ...
                                               <a href="<?= site_url('/survey'); ?>">
                                                   <div class="nav-link btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light <?= current_url(true)->getSegment(2) == 'survey' ? 'active' : ''; ?>" data-bs-toggle="tab">
                                                       <!--begin::Svg Icon | path: icons/duotune/general/gen032.svg-->
                                                       <span class="svg-icon svg-icon-2x">
                                                           <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                           ...
                                           <div class="nav-item mb-2 text-center" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Grafik">
                                               ...
                                               <?php if (session()->get('users_role_id') == 1) : ?>
                                                   <a href="<?= site_url('grafik/listopd'); ?>">
                                                       <div class="nav-link btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light <?= current_url(true)->getSegment(2) == 'grafik' ? 'active' : ''; ?>" data-bs-toggle="tab">
                                       ...
                                       <div class="nav-item mb-2 text-center" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Laporan">
                                           ...
                                           <?php if (session()->get('users_role_id') == 1) : ?>
                                               <a href="<?= site_url('/laporan/listopd'); ?>">
                                                   <div class="nav-link btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light <?= current_url(true)->getSegment(2) == 'laporan' ? 'active' : ''; ?>" data-bs-toggle="tab">
                                       ...
                                       <div class="nav-item mb-2 text-center" data-bs-toggle="tooltip" data-bs-trigger="hover" data-bs-placement="right" data-bs-dismiss="click" title="Berita">
                                           ...
                                           <?php if (session()->get('users_role_id') == 1) : ?>
                                               <a href="<?= site_url('berita/listopd'); ?>">
                                                   <div class="nav-link btn btn-icon btn-active-color-primary btn-color-gray-400 btn-active-light <?= current_url(true)->getSegment(2) == 'berita' ? 'active' : ''; ?>" data-bs-toggle="tab">
                                                       <!--begin::Svg Icon | path: icons/duotune/abstract/abs027.svg-->
                                                       <span class="svg-icon svg-icon-2x">
                                                           <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                                           ...
                                           <div id="kt_aside_menu_wrapper" class="menu-fit">
                                               <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                   <div class="menu-active-bg">
                                                       <div class="menu-item">
                                                           <a class="menu-link <?= current_url(true)->getSegment(2) == 'dashboard' ? 'active' : ''; ?>" href="<?= site_url('/dashboard'); ?>">
                                           ...
                                           <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 px-6 my-5 my-lg-0" id="kt_aside_menu" data-kt-menu="true">
                                               <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                   <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                       <div class="menu-active-bg">
                                                           <div class="menu-item">
                                                               <a class="menu-link mt-3 <?= current_url(true)->getSegment(2) == 'opd' ? 'active' : ''; ?>" href="<?= site_url('/opd'); ?>">
                                           ...
                                           <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 px-6 my-5 my-lg-0" id="kt_aside_menu" data-kt-menu="true">
                                               <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                   <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                       <div class="menu-active-bg">
                                                           <div class="menu-item">
                                                               <a class="menu-link mt-3 <?= current_url(true)->getSegment(2) == 'opsi' ? 'active' : ''; ?>" href="<?= site_url('/opsi'); ?>">
                                           ...
                                           <div class="menu menu-column menu-fit menu-rounded menu-title-gray-600 menu-icon-gray-400 menu-state-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold fs-5 px-6 my-5 my-lg-0" id="kt_aside_menu" data-kt-menu="true">
                                               <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                   <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                       <div class="menu-active-bg">
                                                           <div class="menu-item">
                                                               <a class="menu-link mt-3 <?= current_url(true)->getSegment(2) == 'survey' ? 'active' : ''; ?>" href="<?= site_url('/survey'); ?>">
                                               ...
                                               <div id="kt_aside_menu_wrapper" class="menu-fit">
                                                   <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                       <div class="menu-active-bg">
                                                           <div class="menu-item">
                                                               <?php if (session()->get('users_role_id') == 1) : ?>
                                                                   <a class="menu-link mt-3 <?= current_url(true)->getSegment(2) == 'grafik' ? 'active' : ''; ?>" href="<?= site_url('grafik/listopd'); ?>">
                                                                       <span class="menu-title">Grafik</span>
                                                                   </a>
                                                               <?php else : ?>
                                                                   <a class="menu-link mt-3 <?= current_url(true)->getSegment(2) == 'grafik' ? 'active' : ''; ?>" href="<?= site_url('grafik/listtahun'); ?>">
                                                                       <span class="menu-title">Grafik</span>
                                                                   </a>
                                                               <?php endif; ?>
                                                           </div>
                                           ...
                                           <div id="kt_aside_menu_wrapper" class="menu-fit">
                                               <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                   <div class="menu-active-bg">
                                                       <div class="menu-item">
                                                           <?php if (session()->get('users_role_id') == 1) : ?>
                                                               <a class="menu-link mt-3 <?= current_url(true)->getSegment(2) == 'laporan' ? 'active' : ''; ?>" href="<?= site_url('/laporan/listopd'); ?>">
                                                                   <span class="menu-title">Laporan</span>
                                                               </a>
                                                           <?php else : ?>
                                                               <a class="menu-link mt-3 <?= current_url(true)->getSegment(2) == 'laporan' ? 'active' : ''; ?>" href="<?= site_url('/laporan/listtahun'); ?>">
                                                                   <span class="menu-title">Laporan</span>
                                                               </a>
                                                           <?php endif; ?>
                                                       </div>
                                           ...
                                           <div id="kt_aside_menu_wrapper" class="menu-fit">
                                               <div data-kt-menu-trigger="click" class="menu-item menu-accordion">
                                                   <div class="menu-active-bg">
                                                       <div class="menu-item">
                                                           <?php if (session()->get('users_role_id') == 1) : ?>
                                                               <a class="menu-link mt-3 <?= current_url(true)->getSegment(2) == 'berita' ? 'active' : ''; ?>" href="<?= site_url('/berita/listopd'); ?>">
                                                                   <span class="menu-title">Berita</span>
                                                               </a>
                                                           <?php else : ?>
                                                               <a class="menu-link mt-3 <?= current_url(true)->getSegment(2) == 'berita' ? 'active' : ''; ?>" href="<?= site_url('/berita'); ?>">
                                                                   <span class="menu-title">Berita</span>
                                                               </a>
                                                           <?php endif ?>
                                                       </div>
